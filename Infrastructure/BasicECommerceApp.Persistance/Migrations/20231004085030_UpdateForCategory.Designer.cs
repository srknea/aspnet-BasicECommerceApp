...
namespace BasicECommerceApp.Persistance.Migrations
{
    ...
    [Migration("20231004085030_UpdateForCategory")]
    partial class UpdateForCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasicECommerceApp.Domain.Entities.Auth.AppRole", b =>
                {
            ...
            modelBuilder.Entity("BasicECommerceApp.Domain.Entities.Auth.UserRefreshToken", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BasicECommerceApp.Domain.Entities.Auth.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BasicECommerceApp.Domain.Entities.Auth.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
